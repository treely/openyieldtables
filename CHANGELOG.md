...
- Add yield table for tree type Pappel ([#92](https://github.com/treely/openyieldtables/pull/92),
...
- Remove length assertion in test ([#59](https://github.com/treely/openyieldtables/pull/59),
